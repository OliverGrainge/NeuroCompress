...
from NeuroPress.QLayers.Binary import BinaryLinear, ApproxBinaryLinear, StochasticBinaryLinear
...
class BinaryMLP(nn.Module):
    def __init__(self):
        ...
        self.fc1 = StochasticBinaryLinear(input_size, hidden_sizes[0])
        self.htanh1 = nn.Hardtanh()
        self.bn1 = nn.BatchNorm1d(hidden_sizes[0])
        self.fc2 = StochasticBinaryLinear(hidden_sizes[0], hidden_sizes[1])
        self.htanh2  = nn.Hardtanh()
        self.bn2 = nn.BatchNorm1d(hidden_sizes[1])
        self.fc3 = StochasticBinaryLinear(hidden_sizes[1], hidden_sizes[2])
        self.htanh3  = nn.Hardtanh()
        self.bn3 = nn.BatchNorm1d(hidden_sizes[2], hidden_sizes[3])

        self.fc4 = StochasticBinaryLinear(hidden_sizes[3], output_size)
