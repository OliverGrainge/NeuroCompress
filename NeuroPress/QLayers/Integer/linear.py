from .quant import compute_scale, quantize_per_tensor, dequantize_per_tensor, forward_quantize_per_tensor
...
class FullQuant(BaseLinear):
    def __init__(self, in_features, out_features, bias=True, act_bits=8, weight_bits=8, weight_type="signed", act_type="signed"):
    ...
    def forward(self, x):
        ...
        q_bias = quantize_per_tensor(self.bias, scale_x * scale_w, 0.0, bits=self.weight_bits, type=self.weight_type)
...
class LinearW8A8(FullQuant):
    def __init__(self, in_features, out_features, bias=True):
        super(LinearW8A8, self).__init__(in_features, out_features, bias=bias, act_bits=8, weight_bits=8, act_type="signed", weight_type="signed")

class LinearW4A8(FullQuant):
    def __init__(self, in_features, out_features, bias=True):
        super(LinearW4A8, self).__init__(in_features, out_features, bias=bias, act_bits=8, weight_bits=4, act_type="signed", weight_type="unsigned")

class LinearW2A8(FullQuant):
    def __init__(self, in_features, out_features, bias=True):
        super(LinearW2A8, self).__init__(in_features, out_features, bias=bias, act_bits=8, weight_bits=2, act_type="signed", weight_type="unsigned")
