...
from NeuroPress.QLayers.Ternary.utils.bitmat import bitmat, terniarize
...
class P2LinearWTA8(nn.Linear):
    ...
    def compute_reg(self, W, threshold=0.5):
        """
...
class P3LinearWTA8Gradual(nn.Linear):
    def __init__(
        self,
        in_features,
        out_features,
...
class P4LinearWTA8Gradual(nn.Linear):
    def __init__(
        self,
        in_features,
        out_features,
